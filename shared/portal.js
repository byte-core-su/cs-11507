...
function showPortal() {
  ...
  const easterEggCard = egg && config.courseGridColumns ? `<a class="course-card easter-egg-card" href="${esc(egg[0])}" title="課程彩蛋">${esc(egg[2] || '✨')} ${esc(egg[1])} ↗</a>` : '';

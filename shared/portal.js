...
function shell(content) { root.innerHTML = `<style>
  #portal-root{min-height:100vh;background:#f8fafc;color:#1e293b;font-family:system-ui,"Noto Sans TC","Microsoft JhengHei",sans-serif} .portal-wrap{max-width:1120px;margin:auto;padding:40px 16px 72px}.portal-card{border:1px solid #e2e8f0;border-radius:24px;background:#fff;box-shadow:0 10px 24px #0f172a0d}.portal-button{border:0;border-radius:14px;background:#4f46e5;padding:13px 18px;color:#fff;font:inherit;font-weight:800;cursor:pointer}.portal-button:hover{background:#4338ca}.portal-input{width:100%;box-sizing:border-box;border:1px solid #cbd5e1;border-radius:14px;padding:13px;font:inherit}.portal-input:focus{outline:3px solid #c7d2fe;border-color:#4f46e5}.portal-term{font-size:12px;font-weight:900;letter-spacing:.16em;color:#c7d2fe}.course-grid,.task-grid,.preparation-grid{display:grid;gap:18px}.course-grid{grid-template-columns:repeat(auto-fit,minmax(220px,1fr))}.course-grid.course-grid--three{grid-template-columns:repeat(3,minmax(0,1fr))}.preparation-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.preparation-card{display:flex;min-height:138px;gap:18px;align-items:center;border:1px solid #bfdbfe;border-radius:22px;background:linear-gradient(135deg,#eff6ff,#f5f3ff);padding:20px;color:#1e3a8a;text-decoration:none;box-shadow:0 10px 22px #1d4ed80d;transition:.2s}.preparation-card:hover{transform:translateY(-3px);border-color:#818cf8;box-shadow:0 14px 28px #4f46e520}.preparation-card__icon{display:grid;flex:0 0 auto;width:52px;height:52px;place-items:center;border-radius:18px;background:#fff;font-size:27px;box-shadow:0 5px 12px #312e8117}.preparation-card p{margin:4px 0 0;color:#475569;font-size:14px;line-height:1.5}.preparation-card b{display:block;margin-top:10px;color:#4f46e5;font-size:13px}.task-grid{grid-template-columns:repeat(auto-fit,minmax(245px,1fr))}.course-card{min-height:240px;border-radius:28px;padding:24px;color:#fff;text-decoration:none;box-shadow:0 12px 24px #0f172a26;transition:.2s}.course-card:hover{transform:translateY(-5px)}.easter-egg-card{align-self:stretch;min-height:240px;padding:24px;border:1px solid #eef2f7;border-radius:28px;background:#f8fafc;color:#cbd5e1;box-shadow:none;font-size:13px;font-weight:800;opacity:.78;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:10px;text-align:center}.easter-egg-card:hover{transform:translateY(-5px);border-color:#e2e8f0;background:#fff;color:#94a3b8;opacity:1}.easter-egg-icon{font-size:34px;transition:transform .2s}.easter-egg-name{max-height:0;opacity:0;overflow:hidden;transform:translateY(8px);transition:max-height .2s,opacity .2s,transform .2s}.easter-egg-card:hover .easter-egg-icon,.easter-egg-card:focus-visible .easter-egg-icon{transform:translateY(-3px)}.easter-egg-card:hover .easter-egg-name,.easter-egg-card:focus-visible .easter-egg-name{max-height:24px;opacity:1;transform:translateY(0)}.task-card{padding:20px}.task-item{display:flex;gap:10px;padding:9px 0;font-size:14px;line-height:1.45}.task-item input{margin-top:3px;accent-color:#4f46e5}.muted{color:#64748b}.error{color:#be123c}.progress{height:10px;overflow:hidden;border-radius:999px;background:#ffffff33}.progress>span{display:block;height:100%;border-radius:inherit;background:#67e8f9}@media(max-width:760px){.course-grid.course-grid--three{grid-template-columns:repeat(2,minmax(0,1fr))}}@media(max-width:640px){.portal-wrap{padding-top:28px}.course-grid.course-grid--three,.preparation-grid{grid-template-columns:1fr}}
  </style>${content}`; }
...
function showPortal() {
  ...
  const preparationCards = preparationList.map(item => `<a class="preparation-card" href="${esc(item.href)}"><span class="preparation-card__icon" aria-hidden="true">${esc(item.icon)}</span><span><span style="font-size:11px;font-weight:900;letter-spacing:.14em;color:#6366f1">BEFORE CLASS</span><strong style="display:block;margin-top:3px;font-size:18px">${esc(item.title)}</strong><p>${esc(item.description)}</p><b>開始準備 →</b></span></a>`).join('');

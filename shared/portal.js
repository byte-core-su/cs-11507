...
function showPortal() {
  ...
  const easterEgg = egg ? `<p style="margin:14px 2px 0;text-align:right"><a href="${esc(egg[0])}" style="color:#94a3b8;font-size:12px;font-weight:700;text-decoration:none" title="課程彩蛋">${esc(egg[2] || '✨')} ${esc(egg[1])} ↗</a></p>` : '';
